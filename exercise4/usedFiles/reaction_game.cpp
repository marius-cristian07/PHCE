...
// Internal linkage: only this translation unit
// can see these names.
namespace
{
...
void button_isr(uint gpio, std::uint32_t events)
{
    ...
    if (!round_state.pressed)
    {
        round_state.stop_us = time_us_32();
        round_state.pressed = true;
    }
}
...
int main()
{
    ...
    while (true)
    {
        ...
        // TODO 2: if round_state.pressed is already true here, the player
